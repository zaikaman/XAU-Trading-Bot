...
class SellImprovementBacktest:
    ...
    def run(self, df, start_date=None, end_date=None, initial_capital=5000.0):
        ...
        for i in range(start_idx, end_idx):
            ...
            # ═══ Detect SMC components (direction-aware for #26) ═══
            ...
            # ═══ #26 Filter C: Asymmetric RR for SELL ═══
...
def main():
    print("=" * 70)
    print("XAUBOT AI — #26 SELL Improvement")
    ...
    # ═══ FINAL SUMMARY ═══
    print(f"\n{'=' * 70}")
    print("#26 SELL IMPROVEMENT — ALL CONFIGURATIONS")
    print("=" * 70)

    print(f"\n  {'Config':<25} {'Trades':>6} {'WR':>6} {'Net PnL':>10} {'DD':>6} {'Sharpe':>7} {'PF':>5} {'Filt':>5} {'vs #24B':>10}")
    print(f"  {'-' * 85}")
    print(f"  {'#1 BASELINE':<25} {'686':>6} {'72.2%':>6} {'$1,449.86':>10} {'5.4%':>6} {'1.98':>7} {'1.52':>5} {'—':>5} {'—':>10}")
    print(f"  {'#24B (base)':<25} {'739':>6} {'80.4%':>6} {'$2,235.00':>10} {'3.4%':>6} {'2.87':>7} {'1.77':>5} {'—':>5} {'—':>10}")
